...
class Game extends JFrame{
    ...
    //getter method for the total_damage variable
    public int getDamage(){
        return total_damage;
    }
    //setter method for adding additional odds
    public void addOddsMod(int odd){
        odds_mod+=odd;
        notifyListeners();
    }
    //getter method for the odds_mod variable
...
class Player extends Game implements Game.Update{
    ...
    private JLabel wal,inc,odm,dam;
    Player(){
        super("Player");
    ...
    */
    class Enemy{
        ...
        Enemy(){
            ...
            earn=enemy_kill+1;
            //Lets user know they are fighting a regular enemy
    ...
    class MiniBoss extends Enemy{
        MiniBoss(){
            ...
            hp=hp*10;
            earn=earn*5;
            //lets user know they are fighting a miniboss
    ...
    class Boss extends Enemy{
        Boss(){
            ...
            hp=hp*100;
            earn=earn*100;
            //lets user know they are fighting a boss
